    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_head_relative_start:
                ...
                RelativeAngleHeadMotion relativeAngleHeadMotion = new RelativeAngleHeadMotion((byte) currentMotor, angle);
            ...
            case R.id.tv_head_absolute_start:
                ...
                AbsoluteAngleHeadMotion absoluteAngleHeadMotion = new AbsoluteAngleHeadMotion((byte) currentMotor, angle);
